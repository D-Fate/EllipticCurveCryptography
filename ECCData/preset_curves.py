from ECCBackend.curves.weierstrass import ShortWeierstrass
...
class CurveDB(object):
    ...
    def _check_names(self, curve_names):
        if len(curve_names & self._taken_names) > 0:
            ...
            raise DuplicateCurveException(
                f'Curve(s) named {taken_names} already registered in curve DB.'
            )
    ...
    def get_entry(self, name):
        ...
        if name not in self._entries:
            raise KeyError(
                f'Curve named {name} is not known in curve database.'
            )
...
cdb = CurveDB()
cdb.register(_CurveDBEntry('brainpoolP160r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP160t1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP192r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP192t1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP224r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP224t1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP256r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP256t1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP320r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP320t1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP384r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP384t1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP512r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('brainpoolP512t1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('prime192v1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('prime192v2', ShortWeierstrass, {
    'a': 0xfffffffffffffffffffffffffffffffefffffffffffffffc,
...
cdb.register(_CurveDBEntry('prime192v3', ShortWeierstrass, {
    'a': 0xfffffffffffffffffffffffffffffffefffffffffffffffc,
...
cdb.register(_CurveDBEntry('prime239v1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('prime239v2', ShortWeierstrass, {
    'a': 0x7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc,
...
cdb.register(_CurveDBEntry('prime239v3', ShortWeierstrass, {
    'a': 0x7fffffffffffffffffffffff7fffffffffff8000000000007ffffffffffc,
...
cdb.register(_CurveDBEntry('prime256v1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('secp112r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('secp112r2', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('secp128r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('secp128r2', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('secp160k1', ShortWeierstrass, {
    'a': 0,
    'b': 7,
...
cdb.register(_CurveDBEntry('secp160r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('secp160r2', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('secp192k1', ShortWeierstrass, {
    'a': 0,
    'b': 3,
...
cdb.register(_CurveDBEntry('secp224k1', ShortWeierstrass, {
    'a': 0,
    'b': 5,
...
cdb.register(_CurveDBEntry('secp224r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('secp256k1', ShortWeierstrass, {
    'a': 0,
    'b': 7,
...
cdb.register(_CurveDBEntry('secp384r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('secp521r1', ShortWeierstrass, {
...
cdb.register(_CurveDBEntry('wap-wsg-idm-ecid-wtls8', ShortWeierstrass, {
    'a': 0,
    'b': 3,
...
cdb.register(_CurveDBEntry('wap-wsg-idm-ecid-wtls9', ShortWeierstrass, {
    'a': 0,
    'b': 3,
...
cdb.register(_CurveDBEntry('Anomalous', ShortWeierstrass, {
...
# Curve imported from SafeCurves http://safecurves.cr.yp.to
cdb.register(_CurveDBEntry('BN(2,254)', ShortWeierstrass, {
    'a': 0,
    'b': 2,
...
# Curve imported from SafeCurves http://safecurves.cr.yp.to
cdb.register(_CurveDBEntry('ANSSI FRP256v1', ShortWeierstrass, {
    'a': -3,
...
cdb.register(_CurveDBEntry('rigol', ShortWeierstrass, {
    'a': 0x2982,
    'b': 0x3408,
